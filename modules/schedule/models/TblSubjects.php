 ...
 */
class TblSubjects extends \app\modules\schedule\models\BaseModel
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(TblTeachersRelSubjects::className(), ['subjects_id' => 'id']);
    }
